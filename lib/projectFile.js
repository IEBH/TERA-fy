...
export default class ProjectFile {
	...
	*/
	constructor(baseFile) {
		...
		this.teraUrl = this.url.replace(/^https:\/\/tera-tools.com\/projects\/(?:.+?)\/project\/(.+)$/, '/project/$1');
	...
	*/
	getContents() {
		return this._tera.getProjectFile(this.id);
	}
	...
	*/
	setContents(contents) {
		return this._tera.setProjectFile(this.id, contents);
	}
