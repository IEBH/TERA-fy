...
export default class ProjectFile {
	...
	*/
	getContents() {
		return this.#tera.getProjectFile(this.id);
	}
	...
	*/
	setContents(contents) {
		return this.#tera.setProjectFile(this.id, contents);
	}
	...
	*/
	getRefs() {
		return this.#tera.getProjectLibrary(this.id);
	}
	...
	*/
	setRefs(refs) {
		return this.#tera.setProjectLibrary(this.id, refs);
	}
