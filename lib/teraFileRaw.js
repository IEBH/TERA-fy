...
* @type {Object}
*
* @property {String} url The full URL of the file, will end in '/' if this is a directory
* @property {String} path The relative path of the file within the entity + entityId
