...
export default class TeraFy {
	...
	*/
	settings = {
		...
		mode: 'detect',
		modeTimeout: 300,
		modeFallback: 'child', // TODO: This should really be 'child' should Kinde ever get around to supporting embedded login pages
	...
	*/
	methods = [
		...
		// Project State
		'getProjectState', 'setProjectState', 'setProjectStateDefaults', 'saveProjectState', 'replaceProjectState', 'applyProjectStatePatch',
